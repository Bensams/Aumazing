...
class BuddyArtCache {
  BuddyArtCache._(this.character, this._sheets, this._layout);
  ...
  /// and only under test.
  static final Map<String, BuddyArtCache> _ready = {};
  static final Map<String, Future<BuddyArtCache>> _inFlight = {};
  ...
  static Future<BuddyArtCache> load(String character) {
    ...
    return _inFlight.putIfAbsent(character, () async {
      ...
      final cache = BuddyArtCache._(character, sheets, _grids);
